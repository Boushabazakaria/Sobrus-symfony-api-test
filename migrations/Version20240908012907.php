 ...
 */
final class Version20240908012907 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE blog_article (id INT AUTO_INCREMENT NOT NULL, author_id INT NOT NULL, title VARCHAR(100) NOT NULL, publication_date DATETIME NOT NULL, creation_date DATETIME NOT NULL, keywords JSON DEFAULT NULL COMMENT \'(DC2Type:json)\', status VARCHAR(50) NOT NULL, slug VARCHAR(255) DEFAULT NULL, cover_picture_ref VARCHAR(255) DEFAULT NULL, content LONGTEXT NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
